...
- **NEW: Domain-specific monitoring** - Track requests, average/min/max duration for specific domains
...
**Note:** Domain metrics include TCP_TUNNEL connections, as these represent the majority of modern HTTPS traffic.
...
Create a `domains.yaml` file to specify which domains to monitor:
...
squid_domain_requests_total{host="example.com",port="443"} 1523
...
squid_domain_avg_duration_seconds{host="example.com",port="443"} 2.456789
...
squid_domain_max_duration_seconds{host="example.com",port="443"} 45.123456
...
squid_domain_min_duration_seconds{host="example.com",port="443"} 0.089123
